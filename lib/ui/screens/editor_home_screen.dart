...
class EditorHomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ResponsiveUtils.buildResponsive(
      context,
      (context, width) => ResponsiveUtils.isMobile(width)
          ? _buildMobileLayout(context, ref, appsAsync)
          : _buildDesktopLayout(context, ref, appsAsync),
    );
  }
  ...
  Widget _buildContent(
    ...
    child: appsAsync.when(
      ...
      error: (e, st) => Center(child: Text('Failed to load applications: $e')),
    ),
  );
